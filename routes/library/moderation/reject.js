// routes/library/moderation/reject.js — HakMun API (v0.12)
// POST /v1/library/reject (root-admin-only)
...
router.post("/v1/library/reject", requireSession, requireRootAdmin, async (req, res) => {
  const rid = req._rid;
