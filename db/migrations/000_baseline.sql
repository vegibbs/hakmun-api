-- 000_baseline.sql
-- Baseline schema snapshot taken 2026-03-18 from sandbox.
-- Represents the full hakmun schema as it existed before the migration
-- system was rebuilt. This file is for bootstrapping fresh environments only.
-- On existing databases (sandbox, production), this migration is pre-marked
-- as applied in schema_migrations — it never actually runs.
--
-- DO NOT EDIT. Historical record of schema state at migration system cutover.
-- Legacy migration history is in schema_change_log (migrations 219-246).

--
-- PostgreSQL database dump
--

\restrict DQH0B4z0IwQyGNTxqvlW14C7THjaREfLLUDORpzxWlc590aGPUtbDC9Ya3yXy8c
...
--
-- Name: update_classes_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_lists_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_lists_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: class_documents; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE IF NOT EXISTS public.class_documents (
    ...
    CONSTRAINT class_documents_document_type_check CHECK ((document_type = ANY (ARRAY['hakdoc'::text, 'google_doc'::text])))
);


--
-- Name: class_lists; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE IF NOT EXISTS public.classes (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    enrollment_code character varying(8),
...
CREATE TABLE IF NOT EXISTS public.content_item_audio_variants (
...
--
-- Name: content_item_grammar_links; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.content_item_grammar_links (
    content_item_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.content_items (
    ...
    politeness character varying(20),
    tense character varying(20),
    politeness_en character varying(30),
...
CREATE TABLE IF NOT EXISTS public.docparse_jobs (
...
CREATE TABLE IF NOT EXISTS public.document_content_item_links (
    document_id uuid NOT NULL,
    content_item_id uuid NOT NULL,
...
--
-- Name: document_fragments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE IF NOT EXISTS public.document_registry_links (
    document_id uuid NOT NULL,
    parse_run_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.document_vocab_items (
    document_id uuid NOT NULL,
    parse_run_id uuid NOT NULL,
    lemma text NOT NULL,
    surface text,
...
CREATE TABLE IF NOT EXISTS public.document_vocab_links (
    document_id uuid NOT NULL,
    user_id uuid NOT NULL,
    lemma text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.grammar_pattern_aliases (
...
CREATE TABLE IF NOT EXISTS public.grammar_pattern_aliases_seed_stage (
    code text NOT NULL,
    alias_raw text NOT NULL,
    alias_norm text NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.grammar_pattern_translations (
...
CREATE TABLE IF NOT EXISTS public.grammar_patterns_seed_stage (
    code text NOT NULL,
    display_name text NOT NULL,
    explanation text NOT NULL,
    level text,
...
CREATE TABLE IF NOT EXISTS public.grammar_rule_families (
...
--
-- Name: hakdoc_blocks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.hakdoc_blocks (
    block_id uuid DEFAULT gen_random_uuid() NOT NULL,
    session_id uuid NOT NULL,
    block_type text DEFAULT 'teacher_note'::text NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
    content jsonb DEFAULT '{}'::jsonb NOT NULL,
    importance integer DEFAULT 0 NOT NULL,
    audio_url text,
    audio_status text DEFAULT 'none'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: hakdoc_sessions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.hakdoc_sessions (
    session_id uuid DEFAULT gen_random_uuid() NOT NULL,
    hakdoc_id uuid NOT NULL,
...
--
-- Name: hakdocs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.hakdocs (
    hakdoc_id uuid DEFAULT gen_random_uuid() NOT NULL,
    teacher_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.hanja_character_levels (
...
CREATE TABLE IF NOT EXISTS public.nikl_entry_hanja_link (
...
CREATE TABLE IF NOT EXISTS public.hanja_level_labels (
    level_code text NOT NULL,
    lang text NOT NULL,
    label text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.hanja_levels (
    level_code text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.hanja_texts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    hanja_character_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.hanja_vocab (
    hanja_character_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.krdict_hanja_link (
...
CREATE TABLE IF NOT EXISTS public.krdict_lexical_entry (
    id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.krdict_lexical_entry_fast (
    snapshot_version text NOT NULL,
    source_entry_id text NOT NULL,
    headword text,
    pos text,
...
CREATE TABLE IF NOT EXISTS public.krdict_term_bank (
    term text NOT NULL,
    reading text,
    pos text NOT NULL,
    level text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.library_moderation_actions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    content_type text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.library_registry_items (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    content_type text NOT NULL,
    content_id uuid NOT NULL,
    owner_user_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.library_review_queue (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    registry_item_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.library_share_grants (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    content_type text NOT NULL,
    content_id uuid NOT NULL,
...
--
-- Name: linked_profiles; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE IF NOT EXISTS public.list_items (
    ...
    CONSTRAINT list_items_item_type_check CHECK (((item_type)::text = ANY ((ARRAY['sentence'::character varying, 'pattern'::character varying, 'vocabulary'::character varying, 'hanja'::character varying])::text[])))
);
...
CREATE TABLE IF NOT EXISTS public.lists (
    ...
    name character varying(255) NOT NULL,
    description text,
    global_weight integer DEFAULT 3 NOT NULL,
    is_active boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    source_kind character varying(40),
    source_document_id uuid,
    CONSTRAINT lists_global_weight_check CHECK (((global_weight >= 1) AND (global_weight <= 5)))
);
...
CREATE TABLE IF NOT EXISTS public.nikl_entries (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_entry_categories (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_entry_conjugations (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_entry_hanja (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_entry_loanword_origin (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_entry_pronunciations (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_label_map (
...
CREATE TABLE IF NOT EXISTS public.nikl_sense_examples (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_sense_multimedia (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    sense_no integer NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_sense_patterns (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    sense_no integer NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_sense_relations (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    sense_no integer NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_sense_translations (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    sense_no integer NOT NULL,
    idx integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_senses (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    sense_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_snapshots (
...
CREATE TABLE IF NOT EXISTS public.nikl_subword_examples (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_subword_patterns (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    subword_no integer NOT NULL,
    subsense_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_subword_relations (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    subword_no integer NOT NULL,
    subsense_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_subword_senses (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    subword_no integer NOT NULL,
    subsense_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_subwords (
    provider text DEFAULT 'krdict'::text NOT NULL,
    provider_target_code text NOT NULL,
    subword_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nikl_target_codes (
...
CREATE TABLE IF NOT EXISTS public.nikl_target_codes_stage (
    target_code integer NOT NULL,
    first_seen_snapshot_id uuid NOT NULL,
    first_seen_lemma text NOT NULL,
    first_seen_object_key text NOT NULL
...
CREATE TABLE IF NOT EXISTS public.nikl_unmapped_fields (
...
CREATE SEQUENCE IF NOT EXISTS public.nikl_unmapped_fields_unmapped_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.pos_labels_lookup (
    lang text NOT NULL,
...
--
-- Name: practice_events; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE IF NOT EXISTS public.saved_document_sources (
...
CREATE TABLE IF NOT EXISTS public.sentence_vocab (
    sentence_id uuid NOT NULL,
    vocab_id uuid NOT NULL,
...
--
-- Name: sentence_vocab_links; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.sentence_vocab_links (
    sentence_vocab_link_id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    lemma text NOT NULL,
    ...
    cefr_confidence numeric(3,2),
    cefr_authority character varying(20) DEFAULT 'unassigned'::character varying,
    cefr_assigned_at timestamp with time zone,
    cefr_assigned_by uuid,
    created_by uuid,
    image_s3_key text,
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab_localized_overrides (
    vocab_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab_split_apply_plan (
    vocab_id uuid NOT NULL,
    sense_index integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab_pos_staging (
    vocab_id uuid NOT NULL,
    lemma text NOT NULL,
    english_gloss text,
    part_of_speech text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab_sense_analysis (
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab_set_items (
...
CREATE TABLE IF NOT EXISTS public.teaching_vocab_split_csv_import (
...
CREATE TABLE IF NOT EXISTS public.topik_i_staging (
    ordinal integer,
    lemma_ko text,
    gloss_en text
);
...
--
-- Name: unmatched_grammar_patterns; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.unmatched_grammar_patterns (
...
--
-- Name: unmatched_vocab; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.unmatched_vocab (
    unmatched_id uuid DEFAULT gen_random_uuid() NOT NULL,
    owner_user_id uuid NOT NULL,
    document_id uuid,
    lemma text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.user_dictionary_pins (
    user_id uuid NOT NULL,
    headword text NOT NULL,
    vocab_id uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL
...
CREATE TABLE IF NOT EXISTS public.user_vocab_exposures (
...
CREATE TABLE IF NOT EXISTS public.users (
    ...
    gloss_language text DEFAULT 'en'::text NOT NULL,
    customize_learning boolean DEFAULT false NOT NULL,
    share_progress_default boolean DEFAULT false NOT NULL,
    allow_teacher_adjust_default boolean DEFAULT false NOT NULL,
    location_city text,
    location_country text,
    share_city boolean DEFAULT false NOT NULL,
    share_country boolean DEFAULT false NOT NULL,
    cefr_current text DEFAULT 'A1'::text NOT NULL,
    cefr_target text,
...
CREATE TABLE IF NOT EXISTS public.vocab_glosses (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    vocab_id uuid NOT NULL,
    attribution_id uuid NOT NULL,
    language text NOT NULL,
...
--
-- Name: vocab_image_assets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.vocab_image_assets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    vocab_id uuid NOT NULL,
...
--
-- Name: class_documents class_documents_class_id_document_type_document_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_documents
    ADD CONSTRAINT class_documents_class_id_document_type_document_id_key UNIQUE (class_id, document_type, document_id);


--
-- Name: class_documents class_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_documents
    ADD CONSTRAINT class_documents_pkey PRIMARY KEY (id);


--
-- Name: class_lists class_lists_class_id_list_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_lists
    ADD CONSTRAINT class_lists_class_id_list_id_key UNIQUE (class_id, list_id);


--
-- Name: class_lists class_lists_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: class_members class_members_class_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: content_item_grammar_links content_item_grammar_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_item_grammar_links
    ADD CONSTRAINT content_item_grammar_links_pkey PRIMARY KEY (content_item_id, grammar_pattern_id);
...
--
-- Name: document_fragments document_fragments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.document_fragments
    ADD CONSTRAINT document_fragments_pkey PRIMARY KEY (fragment_id);
...
--
-- Name: hakdoc_blocks hakdoc_blocks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdoc_blocks
    ADD CONSTRAINT hakdoc_blocks_pkey PRIMARY KEY (block_id);


--
-- Name: hakdoc_sessions hakdoc_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdoc_sessions
    ADD CONSTRAINT hakdoc_sessions_pkey PRIMARY KEY (session_id);


--
-- Name: hakdocs hakdocs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdocs
    ADD CONSTRAINT hakdocs_pkey PRIMARY KEY (hakdoc_id);
...
--
-- Name: linked_profiles linked_profiles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.linked_profiles
    ADD CONSTRAINT linked_profiles_pkey PRIMARY KEY (apple_sub, user_id);


--
-- Name: list_items list_items_list_id_item_type_item_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.list_items
    ADD CONSTRAINT list_items_list_id_item_type_item_id_key UNIQUE (list_id, item_type, item_id);
...
ALTER TABLE ONLY public.practice_completions
    ADD CONSTRAINT practice_completions_pkey PRIMARY KEY (completion_id);


--
-- Name: practice_events practice_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.practice_events
    ADD CONSTRAINT practice_events_pkey PRIMARY KEY (event_id);
...
--
-- Name: sentence_vocab_links sentence_vocab_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sentence_vocab_links
    ADD CONSTRAINT sentence_vocab_links_pkey PRIMARY KEY (sentence_vocab_link_id);


--
-- Name: sentence_vocab_links sentence_vocab_links_sentence_content_item_id_teaching_voca_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sentence_vocab_links
    ADD CONSTRAINT sentence_vocab_links_sentence_content_item_id_teaching_voca_key UNIQUE (sentence_content_item_id, teaching_vocab_id);
...
--
-- Name: unmatched_grammar_patterns unmatched_grammar_patterns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_grammar_patterns
    ADD CONSTRAINT unmatched_grammar_patterns_pkey PRIMARY KEY (unmatched_id);


--
-- Name: unmatched_vocab unmatched_vocab_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_vocab
    ADD CONSTRAINT unmatched_vocab_pkey PRIMARY KEY (unmatched_id);
...
--
-- Name: unmatched_grammar_patterns uq_unmatched_user_alias; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: unmatched_vocab uq_unmatched_vocab_user_lemma; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_vocab
    ADD CONSTRAINT uq_unmatched_vocab_user_lemma UNIQUE (owner_user_id, lemma);
...
ALTER TABLE ONLY public.user_feature_flags
    ADD CONSTRAINT user_feature_flags_pkey PRIMARY KEY (user_id, flag_key);
...
--
-- Name: vocab_image_assets vocab_image_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vocab_image_assets
    ADD CONSTRAINT vocab_image_assets_pkey PRIMARY KEY (id);
...
CREATE INDEX IF NOT EXISTS idx_auth_identities_user_id ON public.auth_identities USING btree (user_id);


--
-- Name: idx_cigl_pattern; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_cigl_pattern ON public.content_item_grammar_links USING btree (grammar_pattern_id);


--
-- Name: idx_class_documents_class; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_class_documents_class ON public.class_documents USING btree (class_id);


--
-- Name: idx_class_lists_class; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_class_lists_class ON public.class_lists USING btree (class_id);
...
CREATE INDEX IF NOT EXISTS idx_class_members_class ON public.class_members USING btree (class_id);
...
CREATE INDEX IF NOT EXISTS idx_class_members_user ON public.class_members USING btree (user_id);


--
-- Name: idx_classes_enrollment_code; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_classes_enrollment_code ON public.classes USING btree (enrollment_code) WHERE (enrollment_code IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_content_item_audio_variants_asset ON public.content_item_audio_variants USING btree (asset_id);
...
CREATE INDEX IF NOT EXISTS idx_content_item_audio_variants_item ON public.content_item_audio_variants USING btree (content_item_id);


--
-- Name: idx_content_items_grammar_pattern; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_content_items_grammar_pattern ON public.content_items USING btree (grammar_pattern_id) WHERE (grammar_pattern_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_content_items_owner ON public.content_items USING btree (owner_user_id);


--
-- Name: idx_content_items_pool_combo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_content_items_pool_combo ON public.content_items USING btree (cefr_level, politeness, tense) WHERE (content_type = 'sentence'::text);


--
-- Name: idx_content_items_tags; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX IF NOT EXISTS idx_dcil_session_date ON public.document_content_item_links USING btree (session_date) WHERE (session_date IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_doc_content_links_doc ON public.document_content_item_links USING btree (document_id);
...
CREATE INDEX IF NOT EXISTS idx_doc_content_links_item ON public.document_content_item_links USING btree (content_item_id);


--
-- Name: idx_doc_fragments_doc_session; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_doc_fragments_doc_session ON public.document_fragments USING btree (document_id, session_date);


--
-- Name: idx_doc_fragments_document; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_doc_fragments_document ON public.document_fragments USING btree (document_id);


--
-- Name: idx_doc_fragments_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_doc_fragments_user ON public.document_fragments USING btree (owner_user_id);
...
CREATE INDEX IF NOT EXISTS idx_doc_vocab_links_doc ON public.document_vocab_links USING btree (document_id);
...
CREATE INDEX IF NOT EXISTS idx_doc_vocab_links_user ON public.document_vocab_links USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_docparse_jobs_document ON public.docparse_jobs USING btree (document_id);
...
CREATE INDEX IF NOT EXISTS idx_docparse_jobs_locked_at ON public.docparse_jobs USING btree (locked_at);
...
CREATE INDEX IF NOT EXISTS idx_docparse_jobs_status_available ON public.docparse_jobs USING btree (status, available_at);
...
CREATE INDEX IF NOT EXISTS idx_document_parse_runs_doc_time ON public.document_parse_runs USING btree (document_id, started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_document_parse_runs_status ON public.document_parse_runs USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_document_registry_links_doc ON public.document_registry_links USING btree (document_id);
...
CREATE INDEX IF NOT EXISTS idx_document_registry_links_registry ON public.document_registry_links USING btree (registry_item_id);
...
CREATE INDEX IF NOT EXISTS idx_document_registry_links_run ON public.document_registry_links USING btree (parse_run_id);
...
CREATE INDEX IF NOT EXISTS idx_document_vocab_items_doc ON public.document_vocab_items USING btree (document_id);
...
CREATE INDEX IF NOT EXISTS idx_document_vocab_items_run ON public.document_vocab_items USING btree (parse_run_id);
...
CREATE INDEX IF NOT EXISTS idx_document_vocab_items_vocab_id ON public.document_vocab_items USING btree (vocab_id);
...
CREATE INDEX IF NOT EXISTS idx_documents_asset ON public.documents USING btree (asset_id);
...
CREATE INDEX IF NOT EXISTS idx_documents_ingest_status ON public.documents USING btree (ingest_status);
...
CREATE INDEX IF NOT EXISTS idx_documents_owner_created ON public.documents USING btree (owner_user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_dvl_session_date ON public.document_vocab_links USING btree (session_date) WHERE (session_date IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_google_oauth_connections_updated ON public.google_oauth_connections USING btree (updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_gpa_alias_norm ON public.grammar_pattern_aliases USING btree (alias_norm);
...
CREATE INDEX IF NOT EXISTS idx_gpa_pattern ON public.grammar_pattern_aliases USING btree (grammar_pattern_id);
...
CREATE INDEX IF NOT EXISTS idx_gpass_norm ON public.grammar_pattern_aliases_seed_stage USING btree (alias_norm);
...
CREATE INDEX IF NOT EXISTS idx_gpss_cefr ON public.grammar_patterns_seed_stage USING btree (cefr_min, cefr_max);
...
CREATE INDEX IF NOT EXISTS idx_gpss_group ON public.grammar_patterns_seed_stage USING btree (pattern_group);
...
CREATE INDEX IF NOT EXISTS idx_gpt_lang_field ON public.grammar_pattern_translations USING btree (lang, field);
...
CREATE INDEX IF NOT EXISTS idx_gpt_pattern ON public.grammar_pattern_translations USING btree (grammar_pattern_id);
...
CREATE INDEX IF NOT EXISTS idx_grammar_patterns_active ON public.grammar_patterns USING btree (active) WHERE (active = true);
...
CREATE INDEX IF NOT EXISTS idx_grammar_patterns_cefr ON public.grammar_patterns USING btree (cefr_min, cefr_max);
...
CREATE INDEX IF NOT EXISTS idx_grammar_patterns_group ON public.grammar_patterns USING btree (pattern_group);


--
-- Name: idx_hakdoc_blocks_session; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_hakdoc_blocks_session ON public.hakdoc_blocks USING btree (session_id);


--
-- Name: idx_hakdoc_sessions_doc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_hakdoc_sessions_doc ON public.hakdoc_sessions USING btree (hakdoc_id);


--
-- Name: idx_hakdoc_sessions_doc_date; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_hakdoc_sessions_doc_date ON public.hakdoc_sessions USING btree (hakdoc_id, session_date);


--
-- Name: idx_hakdocs_teacher; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_hakdocs_teacher ON public.hakdocs USING btree (teacher_id);
...
CREATE INDEX IF NOT EXISTS idx_khl_hanja_character ON public.krdict_hanja_link USING btree (hanja_character_id);
...
CREATE INDEX IF NOT EXISTS idx_khl_krdict_entry ON public.krdict_hanja_link USING btree (krdict_entry_id);
...
CREATE INDEX IF NOT EXISTS idx_krdict_fast_hanja ON public.krdict_lexical_entry_fast USING btree (hanja) WHERE (hanja IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_krdict_fast_headword ON public.krdict_lexical_entry_fast USING btree (headword);
...
CREATE INDEX IF NOT EXISTS idx_krdict_fast_pos ON public.krdict_lexical_entry_fast USING btree (pos);
...
CREATE INDEX IF NOT EXISTS idx_krdict_headword ON public.krdict_lexical_entry USING btree (headword);
...
CREATE INDEX IF NOT EXISTS idx_krdict_snapshot ON public.krdict_lexical_entry USING btree (snapshot_version);
...
CREATE INDEX IF NOT EXISTS idx_library_registry_global_active ON public.library_registry_items USING btree (global_state, created_at DESC) WHERE ((audience = 'global'::text) AND (operational_status = 'active'::text) AND (global_state = ANY (ARRAY['preliminary'::text, 'approved'::text])));
...
CREATE INDEX IF NOT EXISTS idx_library_registry_under_review ON public.library_registry_items USING btree (created_at DESC) WHERE (operational_status = 'under_review'::text);
...
CREATE INDEX IF NOT EXISTS idx_library_review_queue_open ON public.library_review_queue USING btree (flagged_at DESC) WHERE (resolved_at IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_library_share_grants_active_content ON public.library_share_grants USING btree (content_type, content_id) WHERE (revoked_at IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_library_share_grants_active_grantee ON public.library_share_grants USING btree (grant_type, grantee_id) WHERE (revoked_at IS NULL);


--
-- Name: idx_linked_profiles_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_linked_profiles_user ON public.linked_profiles USING btree (user_id);


--
-- Name: idx_list_items_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_list_items_item ON public.list_items USING btree (item_type, item_id);
...
--
-- Name: idx_lists_source_document; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_lists_source_document ON public.lists USING btree (user_id, source_document_id) WHERE (source_document_id IS NOT NULL);


--
-- Name: idx_lists_user_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_lists_user_active ON public.lists USING btree (user_id, is_active);
...
CREATE INDEX IF NOT EXISTS idx_lma_actor_created ON public.library_moderation_actions USING btree (actor_user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_lma_content_created ON public.library_moderation_actions USING btree (content_type, content_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_lma_created_at ON public.library_moderation_actions USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_media_assets_created_at ON public.media_assets USING btree (created_at);
...
CREATE INDEX IF NOT EXISTS idx_media_assets_owner_user_id ON public.media_assets USING btree (owner_user_id);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entries_grade ON public.nikl_entries USING btree (word_grade_ko);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entries_headword ON public.nikl_entries USING btree (headword);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entries_pos ON public.nikl_entries USING btree (pos_ko);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entries_snapshot ON public.nikl_entries USING btree (raw_snapshot_id);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_categories_target ON public.nikl_entry_categories USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_categories_type ON public.nikl_entry_categories USING btree (category_type);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_conjugations_target ON public.nikl_entry_conjugations USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_hanja_link_hanja ON public.nikl_entry_hanja_link USING btree (hanja_character_id);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_hanja_link_target ON public.nikl_entry_hanja_link USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_hanja_target ON public.nikl_entry_hanja USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_loanword_origin_target ON public.nikl_entry_loanword_origin USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_entry_pronunciations_target ON public.nikl_entry_pronunciations USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_examples_target_sense ON public.nikl_sense_examples USING btree (provider, provider_target_code, sense_no);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_examples_type ON public.nikl_sense_examples USING btree (example_type_ko);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_multimedia_target_sense ON public.nikl_sense_multimedia USING btree (provider, provider_target_code, sense_no);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_multimedia_type ON public.nikl_sense_multimedia USING btree (media_type_ko);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_patterns_target_sense ON public.nikl_sense_patterns USING btree (provider, provider_target_code, sense_no);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_relations_link_target ON public.nikl_sense_relations USING btree (link_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_relations_target_sense ON public.nikl_sense_relations USING btree (provider, provider_target_code, sense_no);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_translations_lang ON public.nikl_sense_translations USING btree (lang);
...
CREATE INDEX IF NOT EXISTS idx_nikl_sense_translations_target_sense ON public.nikl_sense_translations USING btree (provider, provider_target_code, sense_no);
...
CREATE INDEX IF NOT EXISTS idx_nikl_senses_target ON public.nikl_senses USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_senses_target_sense ON public.nikl_senses USING btree (provider, provider_target_code, sense_no);
...
CREATE INDEX IF NOT EXISTS idx_nikl_snapshots_view_unparsed ON public.nikl_snapshots USING btree (endpoint, parsed_at) WHERE (endpoint = 'view'::text);
...
CREATE INDEX IF NOT EXISTS idx_nikl_subword_examples_target ON public.nikl_subword_examples USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_subword_patterns_target ON public.nikl_subword_patterns USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_subword_relations_link_target ON public.nikl_subword_relations USING btree (link_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_subword_relations_target ON public.nikl_subword_relations USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_subword_senses_target ON public.nikl_subword_senses USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_subwords_target ON public.nikl_subwords USING btree (provider, provider_target_code);
...
CREATE INDEX IF NOT EXISTS idx_nikl_target_codes_first_seen_lemma ON public.nikl_target_codes USING btree (first_seen_lemma);
...
CREATE INDEX IF NOT EXISTS idx_nikl_unmapped_fields_target ON public.nikl_unmapped_fields USING btree (provider, provider_target_code);


--
-- Name: idx_practice_completions_dedup; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_practice_completions_dedup ON public.practice_completions USING btree (user_id, item_id, module, completed_at);


--
-- Name: idx_practice_completions_user_module; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_practice_completions_user_module ON public.practice_completions USING btree (user_id, module, completed_at DESC);


--
-- Name: idx_practice_completions_user_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_practice_completions_user_time ON public.practice_completions USING btree (user_id, completed_at DESC);


--
-- Name: idx_practice_events_dedup; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_practice_events_dedup ON public.practice_events USING btree (user_id, ts, domain, event_type, item_ids);


--
-- Name: idx_practice_events_user_domain; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_practice_events_user_domain ON public.practice_events USING btree (user_id, domain, ts DESC);


--
-- Name: idx_practice_events_user_ts; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_practice_events_user_ts ON public.practice_events USING btree (user_id, ts DESC);
...
CREATE INDEX IF NOT EXISTS idx_saved_document_sources_owner_updated ON public.saved_document_sources USING btree (owner_user_id, updated_at DESC);


--
-- Name: idx_svl_by_sentence; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_svl_by_sentence ON public.sentence_vocab_links USING btree (sentence_content_item_id);


--
-- Name: idx_svl_by_vocab; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_svl_by_vocab ON public.sentence_vocab_links USING btree (teaching_vocab_id);


--
-- Name: idx_teaching_vocab_cefr_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_teaching_vocab_cefr_level ON public.teaching_vocab USING btree (cefr_level);
...
CREATE INDEX IF NOT EXISTS idx_teaching_vocab_localized_overrides_lang ON public.teaching_vocab_localized_overrides USING btree (lang);
...
CREATE INDEX IF NOT EXISTS idx_teaching_vocab_set_items_set ON public.teaching_vocab_set_items USING btree (set_code, snapshot_version);
...
CREATE INDEX IF NOT EXISTS idx_teaching_vocab_set_items_vocab ON public.teaching_vocab_set_items USING btree (vocab_id);


--
-- Name: idx_teaching_vocab_tags; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_teaching_vocab_tags ON public.teaching_vocab USING gin (tags);


--
-- Name: idx_unmatched_grammar_norm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_unmatched_grammar_norm ON public.unmatched_grammar_patterns USING btree (alias_norm);


--
-- Name: idx_unmatched_grammar_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_unmatched_grammar_user ON public.unmatched_grammar_patterns USING btree (owner_user_id);


--
-- Name: idx_unmatched_vocab_lemma; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_unmatched_vocab_lemma ON public.unmatched_vocab USING btree (lemma);


--
-- Name: idx_unmatched_vocab_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_unmatched_vocab_user ON public.unmatched_vocab USING btree (owner_user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_dictionary_pins_user_created ON public.user_dictionary_pins USING btree (user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_user_dictionary_pins_vocab_id ON public.user_dictionary_pins USING btree (vocab_id);


--
-- Name: idx_user_feature_flags_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_user_feature_flags_user ON public.user_feature_flags USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_handles_primary_handle ON public.user_handles USING btree (primary_handle);
...
CREATE INDEX IF NOT EXISTS idx_user_handles_user_id ON public.user_handles USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_profiles_updated_at ON public.user_profiles USING btree (updated_at);
...
CREATE INDEX IF NOT EXISTS idx_user_vocab_exposures_user_lemma ON public.user_vocab_exposures USING btree (user_id, lemma);
...
CREATE INDEX IF NOT EXISTS idx_user_vocab_exposures_user_time ON public.user_vocab_exposures USING btree (user_id, occurred_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_user_vocab_exposures_vocab_id ON public.user_vocab_exposures USING btree (vocab_id);
...
CREATE INDEX IF NOT EXISTS idx_user_vocab_items_user_last_seen ON public.user_vocab_items USING btree (user_id, last_seen_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_user_vocab_items_user_rotation ON public.user_vocab_items USING btree (user_id, rotation_level_computed);
...
CREATE INDEX IF NOT EXISTS idx_user_vocab_items_vocab_id ON public.user_vocab_items USING btree (vocab_id);


--
-- Name: idx_via_batch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_via_batch ON public.vocab_image_assets USING btree (batch_number);


--
-- Name: idx_via_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_via_status ON public.vocab_image_assets USING btree (status);


--
-- Name: idx_via_vocab; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_via_vocab ON public.vocab_image_assets USING btree (vocab_id);
...
CREATE INDEX IF NOT EXISTS ix_hanja_texts_lookup ON public.hanja_texts USING btree (text_type, lang, hanja_character_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_content_item_audio_variants_one_default_per_item ON public.content_item_audio_variants USING btree (content_item_id) WHERE (is_default = true);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_hanja_character_ranking_mv_id ON public.hanja_character_ranking_mv USING btree (hanja_character_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_library_review_queue_one_open_per_item ON public.library_review_queue USING btree (registry_item_id) WHERE (resolved_at IS NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_nikl_unmapped_fields_dedupe ON public.nikl_unmapped_fields USING btree (snapshot_id, xml_path, COALESCE(provider_target_code, ''::text), COALESCE(raw_value, ''::text));
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_user_handles_one_primary_per_user ON public.user_handles USING btree (user_id) WHERE (kind = 'primary'::text);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_users_user_id ON public.users USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS users_is_admin_idx ON public.users USING btree (is_admin) WHERE (is_admin = true);
...
CREATE UNIQUE INDEX IF NOT EXISTS users_user_id_uidx ON public.users USING btree (user_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_hanja_texts_unique ON public.hanja_texts USING btree (hanja_character_id, text_type, lang, text_value);
...
CREATE TRIGGER trg_classes_updated_at BEFORE UPDATE ON public.classes FOR EACH ROW EXECUTE FUNCTION public.update_classes_updated_at();
...
--
-- Name: lists trigger_lists_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_lists_updated_at BEFORE UPDATE ON public.lists FOR EACH ROW EXECUTE FUNCTION public.update_lists_updated_at();
...
--
-- Name: class_documents class_documents_class_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_documents
    ADD CONSTRAINT class_documents_class_id_fkey FOREIGN KEY (class_id) REFERENCES public.classes(class_id) ON DELETE CASCADE;


--
-- Name: class_lists class_lists_class_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_lists
    ADD CONSTRAINT class_lists_class_id_fkey FOREIGN KEY (class_id) REFERENCES public.classes(class_id) ON DELETE CASCADE;


--
-- Name: class_lists class_lists_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_lists
    ADD CONSTRAINT class_lists_list_id_fkey FOREIGN KEY (list_id) REFERENCES public.lists(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.class_members
    ADD CONSTRAINT class_members_class_id_fkey FOREIGN KEY (class_id) REFERENCES public.classes(class_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.class_members
    ADD CONSTRAINT class_members_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
...
--
-- Name: content_item_grammar_links content_item_grammar_links_content_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_item_grammar_links
    ADD CONSTRAINT content_item_grammar_links_content_item_id_fkey FOREIGN KEY (content_item_id) REFERENCES public.content_items(content_item_id) ON DELETE CASCADE;


--
-- Name: content_item_grammar_links content_item_grammar_links_grammar_pattern_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_item_grammar_links
    ADD CONSTRAINT content_item_grammar_links_grammar_pattern_id_fkey FOREIGN KEY (grammar_pattern_id) REFERENCES public.grammar_patterns(id) ON DELETE CASCADE;


--
-- Name: content_items content_items_grammar_pattern_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_items
    ADD CONSTRAINT content_items_grammar_pattern_id_fkey FOREIGN KEY (grammar_pattern_id) REFERENCES public.grammar_patterns(id) ON DELETE SET NULL;
...
--
-- Name: document_fragments document_fragments_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.document_fragments
    ADD CONSTRAINT document_fragments_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(document_id) ON DELETE CASCADE;


--
-- Name: document_fragments document_fragments_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.document_fragments
    ADD CONSTRAINT document_fragments_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
...
--
-- Name: hakdoc_blocks hakdoc_blocks_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdoc_blocks
    ADD CONSTRAINT hakdoc_blocks_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.hakdoc_sessions(session_id) ON DELETE CASCADE;


--
-- Name: hakdoc_sessions hakdoc_sessions_hakdoc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdoc_sessions
    ADD CONSTRAINT hakdoc_sessions_hakdoc_id_fkey FOREIGN KEY (hakdoc_id) REFERENCES public.hakdocs(hakdoc_id) ON DELETE CASCADE;


--
-- Name: hakdocs hakdocs_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdocs
    ADD CONSTRAINT hakdocs_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.users(user_id) ON DELETE SET NULL;


--
-- Name: hakdocs hakdocs_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hakdocs
    ADD CONSTRAINT hakdocs_teacher_id_fkey FOREIGN KEY (teacher_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
...
--
-- Name: linked_profiles linked_profiles_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.linked_profiles
    ADD CONSTRAINT linked_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
...
--
-- Name: lists lists_source_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lists
    ADD CONSTRAINT lists_source_document_id_fkey FOREIGN KEY (source_document_id) REFERENCES public.documents(document_id) ON DELETE SET NULL;
...
--
-- Name: practice_completions practice_completions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.practice_completions
    ADD CONSTRAINT practice_completions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);


--
-- Name: practice_events practice_events_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.practice_events
    ADD CONSTRAINT practice_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
--
-- Name: sentence_vocab_links sentence_vocab_links_sentence_content_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sentence_vocab_links
    ADD CONSTRAINT sentence_vocab_links_sentence_content_item_id_fkey FOREIGN KEY (sentence_content_item_id) REFERENCES public.content_items(content_item_id) ON DELETE CASCADE;


--
-- Name: sentence_vocab_links sentence_vocab_links_teaching_vocab_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sentence_vocab_links
    ADD CONSTRAINT sentence_vocab_links_teaching_vocab_id_fkey FOREIGN KEY (teaching_vocab_id) REFERENCES public.teaching_vocab(id) ON DELETE CASCADE;
...
--
-- Name: teaching_vocab teaching_vocab_cefr_assigned_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.teaching_vocab
    ADD CONSTRAINT teaching_vocab_cefr_assigned_by_fkey FOREIGN KEY (cefr_assigned_by) REFERENCES public.users(user_id);


--
-- Name: teaching_vocab teaching_vocab_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.teaching_vocab
    ADD CONSTRAINT teaching_vocab_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(user_id);
...
--
-- Name: unmatched_grammar_patterns unmatched_grammar_patterns_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_grammar_patterns
    ADD CONSTRAINT unmatched_grammar_patterns_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(document_id) ON DELETE SET NULL;


--
-- Name: unmatched_grammar_patterns unmatched_grammar_patterns_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_grammar_patterns
    ADD CONSTRAINT unmatched_grammar_patterns_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;


--
-- Name: unmatched_vocab unmatched_vocab_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_vocab
    ADD CONSTRAINT unmatched_vocab_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(document_id) ON DELETE SET NULL;


--
-- Name: unmatched_vocab unmatched_vocab_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unmatched_vocab
    ADD CONSTRAINT unmatched_vocab_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_feature_flags
    ADD CONSTRAINT user_feature_flags_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(user_id) ON DELETE SET NULL;
...
--
-- Name: vocab_image_assets vocab_image_assets_vocab_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vocab_image_assets
    ADD CONSTRAINT vocab_image_assets_vocab_id_fkey FOREIGN KEY (vocab_id) REFERENCES public.teaching_vocab(id);
...
\unrestrict DQH0B4z0IwQyGNTxqvlW14C7THjaREfLLUDORpzxWlc590aGPUtbDC9Ya3yXy8c
